#!/usr/bin/bash
#SBATCH --job-name=test_od_llm_link_pipeline                   # Name of your job
...
#SBATCH --mem=50G                                 # Memory required for the job
#SBATCH -t 3-00:00:00                             # Max time of 7 days (adjust as needed)
#SBATCH -p general                                # Partition name (default: general)
#SBATCH -q public                                 # QoS (default: public)
#SBATCH --gpus=a100:2                             # Requesting 1 A100 GPU
...
python3 -u /home/sbachira/llm_od/pipeline/llm_od_link.py > results/logs/output.log 2> results/logs/output.err
